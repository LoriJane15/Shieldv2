...
class SubmitCertificationForSigningRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('submitForSigning', $this->route('japicCertificationProcessing')) ?? false;
    }
    ...
    public function after(): array
    {
        return [function (Validator $validator): void {
            if (array_diff(array_keys($this->all()), ['_token', 'revision', 'lock_version', 'delay_reason']) !== []) {
