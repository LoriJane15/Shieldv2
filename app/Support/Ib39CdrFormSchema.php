...
class Ib39CdrFormSchema
{
    ...
    {
        return [
            'cover' => self::s('Cover/control information', ['report_date' => self::f('Report date', 'date', 20), 'cdr_reference' => self::f('CDR reference', 'text', 100), 'subject_name' => self::f('Name', 'text', 255), 'alias' => self::f('Alias', 'text', 255)]),
            'personal' => self::s('Personal Data', [
                'gender' => self::f('Gender'), 'individual_affiliation' => self::f('Individual affiliation', 'text', 1000), 'position_held' => self::f('Position held', 'text', 1000),
                'classification' => self::f('Classification', 'text', 255), 'last_contact' => self::f('Last contact with the group', 'text', 500), 'duration_with_group' => self::f('Duration/stay with the group', 'text', 500),
                'documents_taken' => self::f('Documents taken from subject', 'textarea', 5000), 'occupation_before_joining' => self::f('Occupation before joining', 'text', 500), 'reason_for_surrender' => self::f('Reason for surrender', 'textarea'),
                'date_of_birth' => self::f('Date of birth', 'date', 20), 'place_of_birth' => self::f('Place of birth', 'text', 1000), 'age_at_entry' => self::f('Age at entry'),
                'present_address' => self::f('Present address', 'textarea', 2000), 'permanent_address' => self::f('Permanent address', 'textarea', 2000), 'civil_status' => self::f('Civil status'),
                'ethnic_group' => self::f('Ethnic group', 'text', 255), 'religion' => self::f('Religion', 'text', 255), 'educational_attainment' => self::f('Educational attainment', 'text', 500),
            ]),
            'physical' => self::s('Physical Description', ['height' => self::f('Height'), 'weight' => self::f('Weight'), 'build' => self::f('Build'), 'complexion' => self::f('Complexion'), 'eye_color' => self::f('Eye color'), 'hair_color' => self::f('Hair color'), 'identification_marks' => self::f('Identification marks', 'textarea', 3000)]),
            'neutralization' => self::s('II. Circumstances of Neutralization', ['neutralization_classification' => self::f('Status of classification', 'text', 500), 'arrest_details' => self::f('Details of arrest/neutralization', 'textarea'), 'reason_for_leaving' => self::f('Reason for leaving the group', 'textarea')]),
    ...
    private static function f(string $label, string $type = 'text', int $max = 10000): array
    {
        return compact('label', 'type', 'max');
    }
