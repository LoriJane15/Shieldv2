...
return [
    ...
    'steps' => [
        ...
        ['code' => '2', 'phase' => 1, 'title' => 'LSWDO Informs the Local E-CLIP Committee', 'roles' => ['lswdo'], 'evidence_key' => 'receiving_unit_coordination', 'depends_on' => ['1'], 'fields' => [
            ['key' => 'receiving_committee', 'label' => 'Receiving committee'], ['key' => 'submission_date', 'label' => 'Submission date', 'type' => 'date'], ['key' => 'confirmation_timestamp', 'label' => 'Confirmation date and time', 'type' => 'datetime-local'], ['key' => 'notification_reference', 'label' => 'Notification reference'],
        ]],
        ...
        ['code' => '4A', 'phase' => 2, 'title' => 'JAPIC Authentication and Certification', 'roles' => ['japic'], 'depends_on' => ['3B'], 'working_days' => 10, 'documents' => ['JAPIC Certification'], 'fields' => [
        ...
        ['code' => '5B', 'phase' => 2, 'title' => 'Record Admission or Halfway-House Support, if Applicable', 'roles' => ['local_eclip_committee'], 'depends_on' => ['5A'], 'allow_na' => true],
        ['code' => '6A', 'phase' => 3, 'title' => 'Encode and Upload Required Files to E-CLIP IS', 'roles' => ['lswdo'], 'depends_on' => ['5B'], 'fields' => [
        ...
        ['code' => '6B', 'phase' => 3, 'title' => 'Generate and Submit Endorsement Letter', 'roles' => ['lswdo'], 'depends_on' => ['6A'], 'documents' => ['Endorsement Letter (Form 7)'], 'enforce_documents' => true, 'fields' => [
            ['key' => 'endorsement_reference', 'label' => 'Endorsement letter reference'],
            ['key' => 'generation_date', 'label' => 'Generation date', 'type' => 'date'],
            ['key' => 'submitted_to_eclip_is_at', 'label' => 'Submitted to E-CLIP IS on', 'type' => 'date'],
        ]],
        ...
        ['code' => '6D', 'phase' => 3, 'title' => 'DILG P/HUC/ICC Review and Form 8 Endorsement', 'roles' => ['dilg_provincial_focal'], 'depends_on' => ['6C'], 'working_days' => 2, 'fields' => [
            ['key' => 'form_8_reference', 'label' => 'Signed Form 8 reference'], ['key' => 'endorsement_date', 'label' => 'Endorsement date', 'type' => 'date'],
        ]],
        ['code' => '6E', 'phase' => 3, 'title' => 'DILG Regional Review and NBOO Endorsement', 'roles' => ['dilg_regional'], 'depends_on' => ['6D'], 'working_days' => 1, 'documents' => ['Form 9'], 'fields' => [
            ['key' => 'form_9_reference', 'label' => 'Form 9 reference'], ['key' => 'endorsement_date', 'label' => 'Endorsement date', 'type' => 'date'],
        ]],
        ['code' => '6F', 'phase' => 3, 'title' => 'NBOO Review and DILG FMS Endorsement', 'roles' => ['nboo_eclip_pmo'], 'depends_on' => ['6E'], 'working_days' => 2, 'documents' => ['Form 10'], 'fields' => [
            ['key' => 'form_10_reference', 'label' => 'Form 10 reference'], ['key' => 'endorsement_date', 'label' => 'Endorsement date', 'type' => 'date'], ['key' => 'eclip_is_reference', 'label' => 'E-CLIP IS reference'],
        ]],
        ['code' => '6G', 'phase' => 3, 'title' => 'DILG FMS Issues SR and NTA', 'roles' => ['dilg_fms'], 'depends_on' => ['6F'], 'working_days' => 5, 'documents' => ['Sub-Allotment Release Order', 'Notice of Transfer Allocation'], 'enforce_documents' => true, 'fields' => [
            ['key' => 'sr_number', 'label' => 'SR number'], ['key' => 'sr_date', 'label' => 'SR date', 'type' => 'date'], ['key' => 'nta_number', 'label' => 'NTA number'], ['key' => 'nta_date', 'label' => 'NTA date', 'type' => 'date'], ['key' => 'approved_amount', 'label' => 'Approved amount', 'type' => 'number'], ['key' => 'receiving_regional_office', 'label' => 'Receiving DILG Regional Office'],
        ]],
        ['code' => '6H', 'phase' => 3, 'title' => 'Record Fund Transfer in E-CLIP IS', 'roles' => ['dilg_fms'], 'depends_on' => ['6G'], 'fields' => [
            ['key' => 'eclip_is_updated_at', 'label' => 'E-CLIP IS update date', 'type' => 'date'], ['key' => 'sr_number', 'label' => 'Approved SR reference'], ['key' => 'amount_transferred', 'label' => 'Amount transferred', 'type' => 'number'], ['key' => 'responsible_office', 'label' => 'Responsible office'],
        ]],
        ['code' => '6I', 'phase' => 3, 'title' => 'DILG Regional Transfers Funds to P/HUC/ICC', 'roles' => ['dilg_regional'], 'depends_on' => ['6H'], 'working_days' => 2, 'fields' => [
            ['key' => 'nta_received_date', 'label' => 'NTA received date', 'type' => 'date'], ['key' => 'fund_transfer_date', 'label' => 'Fund-transfer date', 'type' => 'date'], ['key' => 'amount_transferred', 'label' => 'Amount transferred', 'type' => 'number'], ['key' => 'recipient_office', 'label' => 'Recipient DILG P/HUC/ICC office'],
        ]],
        ['code' => '7A', 'phase' => 3, 'title' => 'Process and Issue Check', 'roles' => ['dilg_provincial_focal'], 'depends_on' => ['6I'], 'working_days' => 5, 'fields' => [
            ['key' => 'assistance_type', 'label' => 'Assistance type'], ['key' => 'amount', 'label' => 'Amount', 'type' => 'number'], ['key' => 'payee', 'label' => 'Payee'], ['key' => 'check_reference', 'label' => 'Masked check or reference number'], ['key' => 'issue_date', 'label' => 'Issue date', 'type' => 'date'], ['key' => 'turnover_schedule', 'label' => 'Turnover schedule', 'type' => 'date'],
        ]],
        ...
        ['code' => '9', 'phase' => 3, 'title' => 'Submit and Maintain Regional Disbursement Report', 'roles' => ['dilg_regional'], 'depends_on' => ['8A'], 'working_days' => 5, 'documents' => ['Finalized Form 11'], 'enforce_documents' => true, 'fields' => [
            ['key' => 'reporting_month', 'label' => 'Reporting month', 'type' => 'month'], ['key' => 'form_11_reference', 'label' => 'Form 11 reference'], ['key' => 'submission_date', 'label' => 'Submission date', 'type' => 'date'], ['key' => 'recipients', 'label' => 'Recipients', 'type' => 'textarea'], ['key' => 'correction_history', 'label' => 'Return / correction history', 'type' => 'textarea'],
        ]],
        ...
        ['code' => '12', 'phase' => 4, 'title' => 'Provide Livelihood Assistance through an Identified Beneficiary', 'roles' => ['lswdo', 'local_eclip_committee'], 'depends_on' => ['10'], 'allow_na' => true, 'fields' => [
        ...
        ['code' => '13', 'phase' => 4, 'title' => 'Record Healing, Reconciliation, and Community Transition', 'roles' => ['lswdo'], 'depends_on' => ['11', '12'], 'fields' => [
            ['key' => 'healing_completed', 'label' => 'Healing activities completed', 'type' => 'checkbox'], ['key' => 'reconciliation_completed', 'label' => 'Reconciliation activities completed', 'type' => 'checkbox'], ['key' => 'livelihood_received', 'label' => 'Livelihood assistance received', 'type' => 'checkbox'], ['key' => 'community_transition_date', 'label' => 'Community-transition date', 'type' => 'date'], ['key' => 'follow_up_schedule', 'label' => 'Follow-up schedule'], ['key' => 'current_area', 'label' => 'Current area'],
        ]],
