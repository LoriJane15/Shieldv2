(function($) {
  ...
  $(function() {
    ...
    function addActiveClass(element) {
      ...
      // Exact-path match only — prevents prefix matches (e.g. /lgu) lighting up every item.
    ...
    if (proBanner && navbar && pageBodyWrapper && $.cookie) {
    ...
    if (bannerClose && proBanner && navbar && pageBodyWrapper && $.cookie) {
