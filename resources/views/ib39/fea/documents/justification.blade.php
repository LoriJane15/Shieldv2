<article class="sheet" data-form="justification">
    ...
    @endforeach
    <section class="question"><div><span class="question-number">3</span>&nbsp;&nbsp;Photo documentation of the firearms surrendered</div><div class="photo-box">EMPTY PHOTO AREA — Photo support will be added in a later stage.</div></section>
    <section class="question"><div><span class="question-number">4</span>&nbsp;&nbsp;Photo of an example of the firearms surrendered that is good condition</div><div class="photo-box">EMPTY PHOTO AREA — Photo support will be added in a later stage.</div></section>
