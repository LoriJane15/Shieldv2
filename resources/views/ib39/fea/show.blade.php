...
<div class="fea-workspace">
    ...
    <div class="row">
        <div class="col-lg-5 mb-4"><section class="card fea-panel h-100"><div class="card-body">
            ...
            <h3 class="fea-title mt-4">Final Actions</h3><div class="disabled-actions"><p class="mb-2">Completion, finalization, final-copy upload, printing, and downloads are unavailable in this preliminary stage and blocked without a secure PSWDO link.</p><strong>Final actions unavailable</strong></div>
        </div></section></div>
