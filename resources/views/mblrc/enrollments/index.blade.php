                                ...
                                @if($enrollment->status === 'in_progress' && $attention)
                                    ...
                                    <form method="POST" action="{{ route('mblrc.enrollments.complete', $enrollment) }}" class="completion-form" data-prevent-double-submit>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6"><label class="form-label" for="intention-date-{{ $enrollment->id }}">Surfacing intention date <span aria-hidden="true">*</span></label><input id="intention-date-{{ $enrollment->id }}" type="date" name="phase_one_evidence[intention_to_surface][intention_date]" class="form-control" value="{{ old('enrollment_id') == $enrollment->id ? old('phase_one_evidence.intention_to_surface.intention_date') : '' }}" max="{{ now()->toDateString() }}" required></div>
                                            <div class="col-md-6"><label class="form-label" for="receiving-unit-{{ $enrollment->id }}">Receiving unit / surfacing location <span aria-hidden="true">*</span></label><input id="receiving-unit-{{ $enrollment->id }}" name="phase_one_evidence[intention_to_surface][receiving_unit]" class="form-control" value="{{ old('enrollment_id') == $enrollment->id ? old('phase_one_evidence.intention_to_surface.receiving_unit') : '' }}" maxlength="255" required></div>
                                            <div class="col-md-6"><label class="form-label" for="graduate-list-{{ $enrollment->id }}">Three-month graduate list reference <span aria-hidden="true">*</span></label><input id="graduate-list-{{ $enrollment->id }}" name="phase_one_evidence[intention_to_surface][graduate_list_reference]" class="form-control" value="{{ old('enrollment_id') == $enrollment->id ? old('phase_one_evidence.intention_to_surface.graduate_list_reference') : '' }}" maxlength="255" required></div>
                                            <div class="col-md-6"><label class="form-label" for="graduate-submission-{{ $enrollment->id }}">Submitted to LSWDO on <span aria-hidden="true">*</span></label><input id="graduate-submission-{{ $enrollment->id }}" type="date" name="phase_one_evidence[intention_to_surface][submission_date]" class="form-control" value="{{ old('enrollment_id') == $enrollment->id ? old('phase_one_evidence.intention_to_surface.submission_date') : '' }}" max="{{ now()->toDateString() }}" required></div>
