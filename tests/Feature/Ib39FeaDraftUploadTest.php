...
class Ib39FeaDraftUploadTest extends TestCase
{
    ...
    public function test_completed_ineligible_deleted_and_server_owned_final_fields_are_rejected(): void
    {
        ...
        $this->actingAs($this->actor)->post($this->storeUrl($document), ['file' => $this->pdf(), 'status' => 'Completed', 'final_copy' => true, 'completed_at' => now()])->assertSessionHasErrors(['status', 'final_copy', 'completed_at']);
