...
class Ib39FeaPreliminaryWorkflowTest extends TestCase
{
    ...
    public function test_update_records_only_meaningful_changes_and_derives_overall_status(): void
    {
        [$actor, $processing, $document] = $this->context();
        ...
        $this->assertDatabaseCount('ib39_fea_processing_histories', 2);
        $this->assertDatabaseHas('ib39_fea_processing_histories', [
            'fea_processing_id' => $processing->id,
            'from_status' => Ib39FeaOverallStatus::Pending->value,
            'to_status' => Ib39FeaOverallStatus::Processing->value,
        ]);
        $this->assertDatabaseHas('ib39_fea_processing_histories', [
            'fea_processing_id' => $processing->id,
            'from_status' => Ib39FeaOverallStatus::Processing->value,
            'to_status' => Ib39FeaOverallStatus::ForCompliance->value,
        ]);
        $this->assertSame(Ib39FeaOverallStatus::ForCompliance, $processing->fresh()->overallStatus());
